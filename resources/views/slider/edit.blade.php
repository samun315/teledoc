        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="sliderForm" action="{{ route('slider.slider.update', $slider->slider_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea class="form-control @error('subtitle') is-invalid @enderror"
                                              ...
                                              name="subtitle"
                                              rows="3"
                                              placeholder="Enter slider subtitle or description">{{ old('subtitle', $slider->subtitle) }}</textarea>
                                    @error('subtitle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <input type="text"
                                               ...
                                               id="button_text_1"
                                               name="button_text_1"
                                               value="{{ old('button_text_1', $slider->button_text_1) }}"
                                    ...
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <input type="text"
                                               ...
                                               id="button_url_1"
                                               name="button_url_1"
                                               value="{{ old('button_url_1', $slider->button_url_1) }}"
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div id="imagePreview" class="mt-2" style="display: none;">
                                        <label class="form-label">New Background Preview:</label>
                                ...
                                <div class="mb-5">
                                    ...
                                    <!-- New Shape Image Preview -->
                                    <div id="shapeImagePreview" class="mt-2" style="display: none;">
                                        <label class="form-label">New Shape Preview:</label>
