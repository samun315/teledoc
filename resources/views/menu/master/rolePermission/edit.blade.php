...
@section('content')
    ...
    <!--begin::Toolbar -->
    <x-toolbar-component title="Edit Role Permission" :breadcrumbs="[
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body py-3">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('menu.master.rolePermission.update', $roleId) }}">
                        @csrf
                            ...
                            <div class="col-md-12 fv-row mb-5">
                                ...
                                <select name="role_id"
                                    ...
                                    @foreach ($userRoles as $userRole)
                                        <option {{ $roleId == $userRole->role_id ? 'selected' : '' }}
                                                ...
                                                @if ($itemName?->item_id == $permission?->item_id)
                                                    <div class="form-check mb-4 ms-2">
                                                        <input
                                                            ...
                                                            @foreach ($editModeData as $editData)
                                                            {{ $editData?->menu_permission_id == $permission->menu_permission_id ? 'checked' : '' }} @endforeach
