            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="item_id" id="item_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Menu Module Name</label>
                            <select name="module_id" id="module_id" class="form-select form-select-solid" data-control="select2"
                                    data-dropdown-parent="#showModal"
                                    data-placeholder="Select menu module name">

                                <option value=""></option>

                                @foreach ($modules as $module)

                                    <option value="{{ $module->module_id }}">{{ $module->module_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-12 fv-row mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                   placeholder="Enter module item name" name="item_name"
                                   id="item_name"/>
                        </div>
