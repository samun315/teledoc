...
@section('title', 'Doctor Schedule List')

@section('content')
    <x-toolbar-component title="Doctor Schedule List" :breadcrumbs="[
        ['label' => 'Home', 'url' => route('dashboard')],
        ['label' => 'Drug & Others', 'url' => 'javascript:void(0)'],
        ['label' => 'Doctor Schedule', 'url' => route('schedule.index')],
        ['label' => 'Doctor Schedule List', 'active' => true],
    ]" actionUrl="{{ route('schedule.create') }}"
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-row-dashed align-middle gs-0 gy-4" id="kt_schedule_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
