            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="department_id" id="kt_department_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Department Name</label>
                            <input type="text"
                                class="form-control form-control-solid @error('department_name') is-invalid @enderror"
                                placeholder="Enter Department Name" name="department_name" id="kt_department_name" />
                        </div>

                        <div class="col-md-12 fv-row mb-5">
                            <label class="fs-5 fw-bold mb-2">Description</label>
                            <textarea data-kt-autosize="true" class="form-control form-control-solid @error('description') is-invalid @enderror"
