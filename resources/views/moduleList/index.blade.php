    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header"  class="header align-items-stretch">
                    ...
                    <div class="container-xxl d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
                            <a href="#">
                                <img alt="Logo" src="{{ asset('assets/media/logos/logo-black-144×30.png') }}" class="h-20px h-lg-30px" />
                            </a>
                        </div>
                        <!--end::Logo-->
                        <!--begin::Wrapper-->
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                            class="menu-item here show me-lg-1">
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                        data-kt-menu="true">
                                        <!--begin::Heading-->
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top master-header"
                                            >
                                            <!--begin::Title-->
                ...
                <!--begin::Content-->
                <div class="d-flex flex-column flex-column-fluid mb-10" id="kt_content">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-header">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">Websites</span>
                                                    </h3>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/website.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Website</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/faq.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">FAQ</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/social.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Social</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">Operations</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/procurement.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Procurement</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/inventory.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Inventory</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/assets.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Assets</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                    ...
                                    <div class="row gy-5 g-xl-8">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">Sales</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Pre-Sales.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Pre- Sales</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Pre-Sales.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Sales</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/CRM.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">CRM</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">HR & Payroll</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Recruitment.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Recruitment</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Employees.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Employees</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Payroll.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Payroll</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                      ...
                                      <div class="row gy-5 g-xl-8">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">Accounting & Finance</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Billing.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Billing</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Accounting.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Accounting</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Finance.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Finance</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">Analytics</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Reporting.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Reporting</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Audit-Report.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Audit Report</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
                                       ...
                                       <div class="row gy-5 g-xl-8">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-xl-stretch">
                                                ...
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">
                                                        <span class="fw-bolder mb-2 text-dark">ERP Setting</span>
                                                    </h3>
                                                </div>
                                                <div class="separator mb-9"></div>
                                                ...
                                                <div class="card-body pt-5">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/User.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">User</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Role.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Role</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/master-data.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Master data</p>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img style="width: 60px; height:60px"
                                                                src="{{ asset('assets/media/landing/Company-Setup.png') }}"
                                                                alt="">
                                                            <p class="fw-bolder mt-2">Company Setup</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end: Card Body-->
