            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="blog_category_id" id="kt_blog_category_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Category Name</label>
                            <input type="text"
                                class="form-control form-control-solid @error('category_name') is-invalid @enderror"
                                placeholder="Enter category name" name="category_name" id="kt_category_name" />
                        </div>
                        ...
                        <div class="col-md-12 fv-row mb-5">
                            ...
                            <textarea class="form-control form-control-solid @error('description') is-invalid @enderror"
                                placeholder="Enter description" name="description" id="kt_description" rows="3" maxlength="500"></textarea>
                        </div>
