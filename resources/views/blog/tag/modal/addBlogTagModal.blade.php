            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="blog_tag_id" id="kt_blog_tag_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Tag Name</label>
                            <input type="text"
                                class="form-control form-control-solid @error('tag_name') is-invalid @enderror"
                                placeholder="Enter tag name" name="tag_name" id="kt_tag_name" />
                        </div>
