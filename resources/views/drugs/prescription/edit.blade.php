...
@endsection
@section('content')
    <x-toolbar-component title="Prescription Edit" :breadcrumbs="[
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('drug.prescription.update', $prescriptionInfo?->prescription_id) }}"
                    id="prescriptionForm">
                    @csrf
                    @if (isset($prescriptionInfo))
                        @method('PUT')
                    @endif
                            ...
                            <div class="col-md-3">
                                <div class="card shadow-sm p-3">
                                    @foreach ($subscriptionTypes as $type)
                                        @php
                                            $record = $prescriptionInfo->clinicalRecord->firstWhere(
                                        ...
                                        <div class="form-group position-relative mb-7">
                                            <textarea class="form-control subscription-textarea" id="subscription_details_{{ $type->subscription_type_id }}"
                                                name="subscription_details[]" rows="3">{{ $record?->subscription_details }}</textarea>
