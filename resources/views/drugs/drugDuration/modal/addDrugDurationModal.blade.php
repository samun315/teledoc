            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="drug_duration_id" id="kt_drug_duration_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Drug Duration</label>
                            <input type="text"
                                class="form-control form-control-solid @error('drug_duration') is-invalid @enderror"
                                placeholder="Enter drug duration name" name="drug_duration" id="kt_drug_duration"
                                required />
                        </div>
