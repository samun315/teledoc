            ...
            <form class="form" action="javascript:void(0)" id="submitForm">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        ...
                        <input type="text" hidden name="subscription_type_id" id="kt_subscription_type_id">

                        <div class="col-md-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Subscription Type</label>
                            <input type="text"
                                class="form-control form-control-solid @error('subscription_type') is-invalid @enderror"
                                placeholder="Enter subscription type" name="subscription_type" id="kt_subscription_type" />
                        </div>
