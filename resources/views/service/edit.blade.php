...
@section('content')
    <x-toolbar-component title="Edit Service" :breadcrumbs="[
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="serviceForm" action="{{ route('service.service.update', $service->service_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div id="iconPreview" class="mt-2">
                                        <i id="previewIcon" class="{{ $service->icon }} fs-2x text-primary"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-5">
                                    ...
                                    @if($service->detail_image)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $service->detail_image) }}"
                                                 alt="Detail"
                                                 class="img-fluid rounded"
                                                 style="max-height: 150px;">
                                        </div>
                                    ...
                                    <div id="detailPreview" class="mt-2" style="display: none;">
                                        <label class="form-label">New Detail Preview:</label>
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="SEO meta description">{{ old('meta_description', $service->meta_description) }}</textarea>
        ...
        $(document).ready(function() {
            ...
            $('#icon').on('input', function() {
                ...
                if (iconClass) {
                    ...
                    $('#previewIcon').attr('class', 'fs-2x text-muted');
                }
            });
        });
