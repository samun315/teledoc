        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="specialityForm" action="{{ route('speciality.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text"
                                           ...
                                           id="icon"
                                           name="icon"
                                           value="{{ old('icon', 'icofont-check-circled') }}"
                                    ...
                                    <div id="iconPreview" class="mt-2">
                                        <i id="previewIcon" class="icofont-check-circled fs-2x text-primary"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-5">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Create Speciality
                            </button>
                        </div>
                    </form>
                </div>
