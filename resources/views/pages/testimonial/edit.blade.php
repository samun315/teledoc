        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="testimonialForm" action="{{ route('testimonial.update', $testimonial->testimonial_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('patient_designation', $testimonial->patient_designation) }}"
