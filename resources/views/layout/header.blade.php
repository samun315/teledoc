    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="javascript:void(0)" class="d-lg-none">
                <img alt="Logo" src="{{ asset('assets/media/logos/logo-black-144×30.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    ...
                                                    HR</a>
                                                <div class="text-gray-400 fs-7">Corporate staff
                                                    profiles
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <div class="text-center text-gray-600 fw-bold pt-1">Outlines
                                            keep you honest. They stopping you from amazing poorly about
                                            drive
                                        </div>
                                        <!--end::Text-->
                                        <!--begin::Action-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10 master-header">
                            <!--begin::Title-->
