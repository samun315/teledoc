...
@section('content')
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="data-table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted text-uppercase fw-bolder fs-7 gs-0">
                                    ...
                                    <th style="width: 70%">User Role Name</th>
    ...
    @include('common.master.userRole.partials.formModal')
...
@section('page_script')
    ...
    <script src="{{ asset('assets/custom/js/common/master/userRole/index.js') }}" {{ Sri::html('assets/custom/js/common/master/userRole/index.js') }}></script>
