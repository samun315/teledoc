...
class PrescriptionController extends Controller
{
    ...
    public function edit(int $prescriptionId): View
    {
        $patientId = Prescription::where('prescription_id', $prescriptionId)
            ->value('patient_id');
        ...
        $data['prescriptionInfo'] = $this->prescriptionService->getPrescriptionInfoById($prescriptionId);
